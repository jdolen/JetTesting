...
if not useMiniAOD:
    ...
    process.source.fileNames = cms.untracked.vstring(
        ...
        'root://cmsxrootd-site.fnal.gov//store/mc/Spring14dr/RSGluonToTT_M-3000_Tune4C_13TeV-pythia8/AODSIM/PU_S14_POSTLS170_V6-v1/00000/0C678F70-05C5-E311-B6A0-003048FFD740.root',
        'root://cmsxrootd-site.fnal.gov//store/mc/Spring14dr/RSGluonToTT_M-3000_Tune4C_13TeV-pythia8/AODSIM/PU_S14_POSTLS170_V6-v1/00000/140DBE80-0EC5-E311-B5BB-003048678B72.root'
    )

if useMiniAOD:
    #process.source.eventsToSkip = cms.untracked.VEventRange('1:1:1368-1:1:1368'), 
    process.source.fileNames = cms.untracked.vstring(
      'file:/uscms_data/d1/jdolen/miniAOD/CMSSW_7_0_6_patch1/src/check_miniAOD-prod_PAT.root',
  )
...
if useMiniAOD:
  outfile = '/eos/uscms/store/user/jdolen/check_100events_TestJetsMiniAOD_706p1.root'
