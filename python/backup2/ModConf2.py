...
process.cmsTopTagGEN = cms.EDProducer(
    "CATopJetProducer",
    GenJetParameters.clone(src = cms.InputTag("packedGenParticles"),
...
process.ca4PFJets.src = 'packedPFCandidates'
...
process.ca8CHSJets  = process.ca8PFJets.clone (src = 'chs')
process.ak15CHSJets = process.ak15PFJets.clone(src = 'chs')

process.load('RecoJets.JetProducers.ak4PFJetsFiltered_cfi')
process.ak15PFJetsFiltered  = process.ak4PFJetsFiltered.clone(rParam=1.5,  doAreaFastjet = True, src = 'packedPFCandidates')
process.ak15CHSJetsFiltered = process.ak4PFJetsFiltered.clone(rParam=1.5,  doAreaFastjet = True, src = 'chs')

process.ak15PFJetsFilteredNfilt2  = process.ak4PFJetsFiltered.clone(rParam=1.5, nFilt=2, rFilt = 0.3,  doAreaFastjet = True, src = 'packedPFCandidates')
process.ak15CHSJetsFilteredNfilt2 = process.ak4PFJetsFiltered.clone(rParam=1.5, nFilt=2, rFilt = 0.3,  doAreaFastjet = True, src = 'chs')

process.ak15PFJetsMassDropFiltered  = process.ak4PFJetsMassDropFiltered.clone(rParam=1.5,  doAreaFastjet = True, src = 'packedPFCandidates')
process.ak15CHSJetsMassDropFiltered = process.ak4PFJetsMassDropFiltered.clone(rParam=1.5,  doAreaFastjet = True, src = 'chs')

process.load('RecoJets.JetProducers.ak4PFJetsTrimmed_cfi')
process.ca8PFJetsTrimmed  = process.ak4PFJetsTrimmed.clone(rParam=0.8, jetAlgorithm = cms.string("CambridgeAachen"), rFilt=0.2, trimPtFracMin=0.05,  doAreaFastjet = True, src = 'packedPFCandidates')
process.ca8CHSJetsTrimmed = process.ak4PFJetsTrimmed.clone(rParam=0.8, jetAlgorithm = cms.string("CambridgeAachen"), rFilt=0.2, trimPtFracMin=0.05,  doAreaFastjet = True, src = 'chs')

process.load('RecoJets.JetProducers.ak4PFJetsPruned_cfi')
process.ca8PFJetsPruned  = process.ak4PFJetsPruned.clone(rParam=0.8, jetAlgorithm = cms.string("CambridgeAachen"), doAreaFastjet = True, src = 'packedPFCandidates')
process.ca8CHSJetsPruned = process.ak4PFJetsPruned.clone(rParam=0.8, jetAlgorithm = cms.string("CambridgeAachen"), doAreaFastjet = True, src = 'chs')

process.ca8PFJetsPrunedNsub3  = process.ak4PFJetsPruned.clone(rParam=0.8, jetAlgorithm = cms.string("CambridgeAachen"), nFilt=3, doAreaFastjet = True, src = 'packedPFCandidates')
process.ca8CHSJetsPrunedNsub3 = process.ak4PFJetsPruned.clone(rParam=0.8, jetAlgorithm = cms.string("CambridgeAachen"), nFilt=3, doAreaFastjet = True, src = 'chs')
...
process.patJetPartonMatchAK15CHS.matched='prunedGenParticles'
process.patJetCorrFactorsAK15CHS.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchAK15PFfiltered.matched='prunedGenParticles'
process.patJetCorrFactorsAK15PFfiltered.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchAK15PFfilteredSubjets.matched='prunedGenParticles'
process.patJetCorrFactorsAK15PFfilteredSubjets.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchAK15CHSfiltered.matched='prunedGenParticles'
process.patJetCorrFactorsAK15CHSfiltered.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchAK15CHSfilteredSubjets.matched='prunedGenParticles'
process.patJetCorrFactorsAK15CHSfilteredSubjets.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchCA8PF.matched='prunedGenParticles'
process.patJetCorrFactorsCA8PF.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchCA8CHS.matched='prunedGenParticles'
process.patJetCorrFactorsCA8CHS.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchCA8PFpruned.matched='prunedGenParticles'
process.patJetCorrFactorsCA8PFpruned.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchCA8PFprunedSubjets.matched='prunedGenParticles'
process.patJetCorrFactorsCA8PFprunedSubjets.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchCA8CHSpruned.matched='prunedGenParticles'
process.patJetCorrFactorsCA8CHSpruned.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchCA8CHSprunedSubjets.matched='prunedGenParticles'
process.patJetCorrFactorsCA8CHSprunedSubjets.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetCorrFactorsCMSTopTagCHS.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetCorrFactorsCMSTopTagCHSSubjets.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchCMSTopTagFJCHS.matched='prunedGenParticles'
process.patJetCorrFactorsCMSTopTagFJCHS.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchCMSTopTagFJCHSSubjets.matched='prunedGenParticles'
process.patJetCorrFactorsCMSTopTagFJCHSSubjets.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchHEPTopTagCHS.matched='prunedGenParticles'
process.patJetCorrFactorsHEPTopTagCHS.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.patJetPartonMatchHEPTopTagCHSSubjets.matched='prunedGenParticles'
process.patJetCorrFactorsHEPTopTagCHSSubjets.primaryVertices = 'offlineSlimmedPrimaryVertices'
...
process.out = cms.OutputModule("PoolOutputModule",
                               fileName = cms.untracked.string('/uscmst1b_scratch/lpc1/lpcphys/jdolen/TestMiniAnalyzer706p1_4000events.root'),
