...
if not useMiniAOD:
    ...
    '/store/mc/Spring14dr/RSGluonToTT_M-3000_Tune4C_13TeV-pythia8/AODSIM/PU_S14_POSTLS170_V6-v1/00000/001F67AD-2BC5-E311-9A0E-003048FFD756.root'
    )
...
###############################################
# PATHS
outfile = '/eos/uscms/store/user/jdolen/check_100events_TestJetsAOD_706p1_verybig.root'
